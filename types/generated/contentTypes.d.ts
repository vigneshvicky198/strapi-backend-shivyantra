...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    otpExpires: Attribute.BigInteger;
...
export interface ApiPagePage extends Schema.CollectionType {
  ...
  attributes: {
    Title: Attribute.String;
    Slider: Attribute.Component<'blocks.slider', true>;
    Category: Attribute.Component<'products.category', true>;
    Section: Attribute.Component<'home-page.section', true>;
    FactoryClips: Attribute.Component<'home-page.factory-clips', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiPurchasedOrderPurchasedOrder extends Schema.CollectionType {
...
export interface ApiRazorpayRazorpay extends Schema.SingleType {
